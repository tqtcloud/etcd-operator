...
import (
	...
	"github.com/tqtcloud/etcd-operator/controllers"
...
var (
	...
	defaultBackupImage = "busybox" // 默认镜像信息
)

func init() {
	utilruntime.Must(clientgoscheme.AddToScheme(scheme))

	utilruntime.Must(etcdv1beta1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "252caed6.tqtcloud.io",
	})
	if err != nil {
	...
	if err = (&controllers.EtcdBackupReconciler{
		Client:      mgr.GetClient(),
		Scheme:      mgr.GetScheme(),
		BackupImage: backupimage, // 传递image信息过去
	}).SetupWithManager(mgr); err != nil {
